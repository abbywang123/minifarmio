...
using Attr = System.Reflection.CustomAttributeExtensions;
...
#if UNITY_EDITOR
               panel.documentationUrl = System.Reflection.CustomAttributeExtensions
    .GetCustomAttribute<HelpURLAttribute>(disposableSettingsPanel.GetType())
    ?.URL;
