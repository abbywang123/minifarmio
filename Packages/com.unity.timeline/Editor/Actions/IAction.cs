...
using UnityEngine;
using GetAttr = System.Reflection.CustomAttributeExtensions;
...
namespace UnityEditor.Timeline.Actions
{
    ...
    static class ActionExtensions
    {
        ...
        public static string GetUndoName(this IAction action)
        {
            ...
            var attr = GetAttr.GetCustomAttribute<ApplyDefaultUndoAttribute>(action.GetType(), false);
        ...
        public static string GetMenuEntryName(this IAction action)
        {
            ...
            var attr = GetAttr.GetCustomAttribute<MenuEntryAttribute>(action.GetType(), false);
        ...
        public static string GetDisplayName(this IAction action)
        {
            ...
            var attr = GetAttr.GetCustomAttribute<DisplayNameAttribute>(action.GetType(), false);
        ...
        {
            var attr = GetAttr.GetCustomAttribute<ActiveInModeAttribute>(action.GetType(), true);
        ...
        public static string GetShortcut(this IAction action)
        {
            ...
            if (string.IsNullOrWhiteSpace(shortCut))
            {
                ...
                var customShortcutMethod = action.GetType().GetMethods().FirstOrDefault(m => GetAttr.GetCustomAttribute<TimelineShortcutAttribute>(m, true) != null);
                if (customShortcutMethod != null)
                {
                    var shortcutId = GetAttr.GetCustomAttribute<TimelineShortcutAttribute>(customShortcutMethod, true).identifier;
